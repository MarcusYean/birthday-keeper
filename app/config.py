...
DEFAULT_CONFIG = {
    ...
    # 消息模板：{name} {calendar_type} {month} {day} {year} {relationship} {note}
    #          {days_until} {age} {age_num} {years_together} {years_together_num} {when}
    #          {zodiac} {chinese_zodiac} {next_date} {kind}
    "templates": {
